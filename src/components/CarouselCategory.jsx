...
const CarouselCategory = () => {
  ...
  return (
    <div className="bg-white m-3">
      <div className="text-2xl font-semibold p-4">Shop by Category<span className="text-sm ml-4 text-cyan-700 cursor-pointer hover:underline">See all deals</span></div>
      <Swiper
        slidesPerView={5}
        spaceBetween={10}
        navigation={true}
